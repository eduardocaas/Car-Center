...
namespace CarCenter.Migrations
{
    ...
    [Migration("20240623200829_Carro_CarroStatus")]
    partial class Carro_CarroStatus
    {
            ...
            modelBuilder.Entity("CarCenter.Models.Nota", b =>
                {
                    ...
                    b.HasIndex(new[] { "Numero" }, "IX_Nota_Numero")
                        .IsUnique();
            ...
            modelBuilder.Entity("CarCenter.Models.Vendedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAdmissao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2024, 6, 23, 17, 8, 29, 597, DateTimeKind.Local).AddTicks(8413))
