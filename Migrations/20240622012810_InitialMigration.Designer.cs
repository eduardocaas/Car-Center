...
namespace CarCenter.Migrations
{
    ...
    [Migration("20240622012810_InitialMigration")]
            ...
            modelBuilder.Entity("CarCenter.Models.Nota", b =>
                {
                    ...
                    b.Property<DateTime>("DataEmissao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2024, 6, 21, 22, 28, 9, 922, DateTimeKind.Local).AddTicks(1774))
                        .HasColumnName("Data_Emissao");

                    b.Property<DateTime>("Garantia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2026, 6, 21, 22, 28, 9, 922, DateTimeKind.Local).AddTicks(2153));
            ...
            modelBuilder.Entity("CarCenter.Models.Vendedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAdmissao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2024, 6, 21, 22, 28, 9, 922, DateTimeKind.Local).AddTicks(3048))
