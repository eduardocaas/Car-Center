...
namespace CarCenter.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Modelo,AnoModelo,AnoFabricacao,Chassi,Preco")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Modelo,AnoModelo,AnoFabricacao,Chassi,Preco")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CarCenterContext.Carros'  is null.");
            }
            var carro = await _context.Carros.FindAsync(id);
            if (carro != null)
            {
